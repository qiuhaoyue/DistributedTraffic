 ...
 * centered at the interception point for the gnomonic projection to be defined.</li>
 * </ul>
 */
...
private static final double eps = 0.01 * Math.sqrt(GeoMath.epsilon);
   ...
   */
  public GeodesicData intercept(double lata1, double lona1, double lata2,
    ...
    double latb2 = (lata1 + lata2) / 2, latb2_ = Double.NaN, lonb2_ =
        Double.NaN;
    double lonb2 =
        ((lona1 >= 0 ? lona1 % 360 : (lona1 % 360) + 360) + (lona2 >= 0
            ? lona2 % 360 : (lona2 % 360) + 360)) / 2;
