...
public abstract class AbstractEdge<E extends AbstractEdge<E>> implements Serializable {
    ...
    public transient E successor = null;
    public transient E neighbor = null;
    /**
     ...
     */
    protected E successor(HashMap<Long, Tuple2<Road,Road>> successorAndNeighbor) {
        return (E) successorAndNeighbor.get(this.id())._1;
    }
     ...
     */
    protected E neighbor(HashMap<Long, Tuple2<Road,Road>> successorAndNeighbor) {
        return (E) successorAndNeighbor.get(this.id())._2;
    }
     ...
     */
    public Iterator<E> successors(final HashMap<Long, Tuple2<Road,Road>> successorAndNeighbor) {
        return new Iterator<E>() {
            E successor = successor(successorAndNeighbor);
            ...
            public E next() {
                ...
                //System.out.println("iterator.neighbor() "+iterator.neighbor()+" successor "+successor);
                //System.out.println("iterator.neighbor() == successor "+(iterator.neighbor() == successor));
                iterator = iterator.neighbor(successorAndNeighbor) == successor ? null : iterator.neighbor(successorAndNeighbor);
                //System.out.println("2 iterator " +iterator);
