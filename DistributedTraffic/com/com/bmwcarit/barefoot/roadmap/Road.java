 ...
 */
public class Road extends AbstractEdge<Road> implements Serializable{
  ...
  //覆盖原来的hashcode和equals方法
    ...
    public boolean equals(Object obj)//覆盖
    {
        ...
        Road s = (Road)obj;
        return this.id()==s.id() && this.source()==s.source() && this.target()==s.target();
    }
}
