 ...
 * of {@link Road}s.
 */
public class Route extends Path<Road> implements Serializable{
    /**
	 * 
	 */
    ...
    //add 0423
    public Route(HashMap<Long, Tuple2<Road,Road>> successorAndNeighbor,RoadPoint source, RoadPoint target, List<Road> roads) {
        super(successorAndNeighbor,source, target, roads);
    }
    /**
